...
class QualificacoesControllerTest < ActionController::TestCase
  ...
  test "should create qualificacao" do
    assert_difference('Qualificacao.count') do
      post :create, qualificacao: { : @qualificacao., cliente_id: @qualificacao.cliente_id, nota: @qualificacao.nota, restaurante_id: @qualificacao.restaurante_id }
    end
  ...
  test "should update qualificacao" do
    patch :update, id: @qualificacao, qualificacao: { : @qualificacao., cliente_id: @qualificacao.cliente_id, nota: @qualificacao.nota, restaurante_id: @qualificacao.restaurante_id }
    assert_redirected_to qualificacao_path(assigns(:qualificacao))
  end
